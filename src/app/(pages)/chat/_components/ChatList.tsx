          ...
          <li className={'pl-2 pr-3 py-4 border-b border-[#e2e2e2]'}>
            <Link href={'/chat/1'}>
              <div className={'flex relative'}>
                ...
                <div className={'flex-1 flex flex-col gap-1.5 ml-2 mr-8 py-1.5'}>
                  <div className={'flex justify-between items-center gap-1'}>
                    <div className={'flex-1 font-bold text-xs text-[#141414] line-clamp-1'}>
                  ...
                  <div className={'flex justify-between items-center gap-1'}>
                    <div className={'flex-1 text-[#969696] text-[10px] tracking-tighter line-clamp-1'}>
