...
export default function BottomNav() {
  return (
    <div className='h-[68px]'>
      <div className='bor fixed bottom-16 z-10 flex h-[68px] w-full max-w-[400px] items-center justify-between rounded-t-3xl bg-white px-2 font-semibold text-v1-text-primary-600 shadow-[0_-1px_0_0_rgba(0,0,0,0.05)]'>
